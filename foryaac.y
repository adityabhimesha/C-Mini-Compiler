...
stmt : expr T_Semicolon					{$$ = $1;  fprintf(ast_tree_output, "\n");}
		| if_stmt						{$$ = $1;  fprintf(ast_tree_output, "\n");}
		| while_stmt					{$$ = $1; fprintf(ast_tree_output, "\n");}
		
		| Assignment_stmt T_Semicolon	{$$ = $1;  fprintf(ast_tree_output, "\n");}
